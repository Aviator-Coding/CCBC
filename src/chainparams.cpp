...
public:
    CMainParams()
    {
        ...
        vPartnerRewardAddress = "SUm8pHsUSs8Amgun38Z9j11LPQzZzV2eJC"   //This address is owned by Mattnyy
            strNetworkID = "main";
        /**
		...
		*/
        ...
        nPOSDGWForkBlock = 220000;
        nPartnerAddressBlock = 220000;
...
{
    if (nHeight >= Params().PARTNER_BLOCK())
        return vPartnerRewardAddress;
    else
